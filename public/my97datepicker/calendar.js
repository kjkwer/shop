...
My97DP.prototype = {
    init: function() {
        ...
        this.loadDate();
        var __minDate = $dp.minDate != $dp.defMinDate ? $dp.realFmt : $dp.realFullFmt;
        var __maxDate = $dp.maxDate != $dp.defMaxDate ? $dp.realFmt : $dp.realFullFmt;
        this.minDate = this.doCustomDate($dp.minDate, __minDate , $dp.defMinDate);
        this.maxDate = this.doCustomDate($dp.maxDate, __maxDate , $dp.defMaxDate);
        ...
        for (F = 1, D = A; F < 7; F++) {
            ...
            for (E = 0; E < 7; E++) {
                ...
                if (_.M == B) {
                    ...
                    K = "WotherDay";
                    $ = "WotherDayOn"
                } else L = false; if ($dp.isShowWeek && E == 0 && (F < 4 || L)) H.a("<td class=Wweek>" + getWeek(_, 1) + "</td>");
                H.a("<td align=center ");
                if (L) {
    ...
    initBtn: function() {
        ...
        else $d.okI.value = $lang.updateStr; if (this.checkValid($tdt)) {
